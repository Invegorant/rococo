...
public class GrpcUserdataService extends RococoUserdataServiceGrpc.RococoUserdataServiceImplBase {
    ...
    public void getUser(UserRequest request, StreamObserver<UserResponse> responseObserver) {
        ...
        if (userEntity != null) {
            ...
            throw new StatusRuntimeException(Status.NOT_FOUND.withDescription("User is not found by username: " + username));
        }
    }
    ...
    public void updateUser(UpdateUserRequest request, StreamObserver<UserResponse> responseObserver) {
        ...
        if (userEntity != null) {
            ...
            throw new StatusRuntimeException(
                    NOT_FOUND.withDescription("User is not found by username: " + username)
            );
        }
    }
}
